...
// FIX: Added .js extension to the relative import to aid module resolution
import { auth, googleProvider, appleProvider, initRecaptcha } from "../lib/firebase.js";
...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    // This listener handles initial sign-in/sign-out state changes
  ...
  // --- NEW FUNCTION: Allows components to manually update the user object ---
  const updateUserContext = (updates) => {
    if (user) {
      // Merge the current user object with the new updates (e.g., photoURL or displayName)
      // This immediately triggers a re-render for all components consuming 'user'.
